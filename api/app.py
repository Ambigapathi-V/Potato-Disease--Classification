...
st.write("Upload one or more images of potato leaves to check for diseases.")
...
st.sidebar.write(
    ...
    - The model is trained on specific diseases like Early Blight, Late Blight, Healthy; ensure the leaf corresponds to these categories.
    """
)
